...
export default function Form() {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("MMERGE3", "English"); // Default to English
    ...
    try {
      ...
      setFormMessage("Thank you for your subscription!");
      setFormMessageColor("text-green-600");
      clearForm();
      // } else {
      //   // Handle subscription error
      //   setFormMessage("Oops, there is an error. Please try again later.");
